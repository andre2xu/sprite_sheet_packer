...
class Controls(components.shared.HorizontalBoxLayout):
    def __init__(self, parent: QtWidgets.QWidget | None = None):
        ...
        self.pack_sprites_btn = QtWidgets.QPushButton(QtGui.QIcon(os.path.join(pathlib.Path(__file__).parent.parent.resolve(), 'icons/pack_sprite_sheet_icon.png')), '')
        ...
        self.pack_sprites_btn.setStyleSheet("""padding: 5px;""")
        ...
        self.lyt.addWidget(self.pack_sprites_btn)
